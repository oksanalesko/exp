(() => {
    ...
    function headerLinkActive() {
        if (serv) {
            if (headerLinkServ) headerLinkServ.classList.add("active-page");
        } else if (about) {
            if (headerLinkAbout) headerLinkAbout.classList.add("active-page");
        } else if (adv) {
            if (headerLinkAdv) headerLinkAdv.classList.add("active-page");
        } else if (creat) if (headerLinkCreat) headerLinkCreat.classList.add("active-page");
    }
    headerLinkActive();
    window["FLS"] = true;
    isWebp();
